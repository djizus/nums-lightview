...
const PaginationLink = ({
  ...
  if (isActive) {
    return (
      <a
        aria-current="page"
        className={cn(baseStyles, "w-12 h-10 p-3 bg-primary-100", className)}
        style={{
          boxShadow:
  ...
  return (
    <a
      className={cn(baseStyles, "w-12 h-10 p-3 bg-primary-700", className)}
      style={{
        boxShadow:
...
const PaginationPrevious = ({
  ...
  return (
    <a
      ...
      className={cn(
        baseStyles,
        isDisabled ? "bg-primary-800" : "bg-primary-700",
        className,
      )}
      style={{
